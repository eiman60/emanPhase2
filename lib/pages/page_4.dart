...
const Map<String, List<_ScheduleItem>> _kSchedulesByZone = {
  'منى': [
    _ScheduleItem(
      ...
      subtitle: 'يوم التروية — اليوم الثامن',
    ...
    _ScheduleItem(
      time: 'حسب الحملة',
      title: 'التفويج إلى عرفة',
      subtitle: 'يوم عرفة — اليوم التاسع',
      type: _ScheduleType.dispatch,
      dependsOnCampaign: true,
      campaignTime: '05:30',
      campaignPeriod: 'ص',
    ...
    _ScheduleItem(
      time: 'حسب الحملة',
      title: 'العودة إلى منى',
      subtitle: 'يوم النحر — من مزدلفة',
      type: _ScheduleType.dispatch,
      dependsOnCampaign: true,
      campaignTime: '04:45',
      campaignPeriod: 'ص',
    ...
    _ScheduleItem(
      ...
      subtitle: 'التحلل الأصغر — يحل من الإحرام',
    ),
    _ScheduleItem(
      time: 'حسب الحملة',
      title: 'التفويج إلى مكة',
      subtitle: 'لطواف الإفاضة — يوم النحر',
      type: _ScheduleType.dispatch,
      dependsOnCampaign: true,
      campaignTime: '11:00',
      campaignPeriod: 'ص',
    ...
    _ScheduleItem(
      ...
      subtitle: 'أيام التشريق — 21 حصاة في كل يوم',
    ),
    _ScheduleItem(
      time: 'حسب الحملة',
      title: 'التفويج النهائي إلى مكة',
      subtitle: 'بعد آخر رمي — اليوم الثالث عشر',
      type: _ScheduleType.dispatch,
      dependsOnCampaign: true,
      campaignTime: '14:30',
      campaignPeriod: 'م',
  ...
  'عرفات': [
    ...
    _ScheduleItem(
      time: 'بعد الزوال',
      title: 'الاستماع لخطبة عرفة',
      subtitle: 'مسجد نمرة أو المخيم',
    ),
    _ScheduleItem(
      time: '12:00',
      period: 'ظ',
      title: 'صلاة الظهر والعصر',
      subtitle: 'جمع تقديم',
    ),
    _ScheduleItem(
      time: 'طوال اليوم',
  ...
  'مزدلفة': [
    ...
    _ScheduleItem(
      time: 'قبل الفجر',
      title: 'جمع الحصى',
      subtitle: 'من 49 إلى 70 حصاة لرمي الجمرات',
